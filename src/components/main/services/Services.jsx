    ...
    demoData = [
      {
        id: 1,
        title: "Send Money",
        description: "Send money from MobiCash to any number instantly",
        imageUrl: "/images/send-money.png",
        link: "/sendMoney",
      },
      {
        id: 2,
        title: "Cash Out",
        description:
          "Withdraw cash anytime from the largest agent and ATM network of Bangladesh",
        imageUrl: "/images/cash-out.png",
        link: "/cashOut",
      },
    ];
  } else {
